...
public class TestCase {
	 ...
	 * Only consumed by {@link VerifyTestCasesTest} to run real jq with {@code -L}; this library's
	 * own implementation check ({@link AbstractJsonQueryTest}) doesn't support modules yet, so
	 * cases needing this are separately marked {@code failing: true}.
	 */
