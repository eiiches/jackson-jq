...
public class CompareEqualTest<JsonNode> extends SimpleBinaryOperatorExpression<JsonNode> {
	public CompareEqualTest(JsonProvider<JsonNode> jsonProvider, Expression<JsonNode> lhs, Expression<JsonNode> rhs) {
		super(jsonProvider, lhs, rhs, new EqualOperator<>());
	}
}
