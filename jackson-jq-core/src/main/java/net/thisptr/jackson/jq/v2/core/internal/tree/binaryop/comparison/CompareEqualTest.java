...
public class CompareEqualTest<JsonNode> extends AbstractComparisonExpression<JsonNode> {
	public CompareEqualTest(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, int lhsOutputIndex, int rhsOutputIndex) {
