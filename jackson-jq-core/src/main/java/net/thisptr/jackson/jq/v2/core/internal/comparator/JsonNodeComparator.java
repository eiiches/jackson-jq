package net.thisptr.jackson.jq.v2.core.internal.comparator;
...
public class JsonNodeComparator<JsonNode> implements Comparator<JsonNode>, Serializable {
	...
	protected int compareObjectNode(JsonNode o1, JsonNode o2) {
		...
		jsonProvider.getObjectMemberNames(o1).forEachRemaining(names1::add);
		List<String> names2 = new ArrayList<>();
		jsonProvider.getObjectMemberNames(o2).forEachRemaining(names2::add);
