...
public class CompareLessTest<JsonNode> extends AbstractComparisonExpression<JsonNode> {
	public CompareLessTest(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, int lhsOutputIndex, int rhsOutputIndex) {
