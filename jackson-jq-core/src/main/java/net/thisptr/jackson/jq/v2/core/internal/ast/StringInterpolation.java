...
public class StringInterpolation implements AstNode {
	private final List<Pair<Integer, AstNode>> interpolations;
	private final String template;
	private final @Nullable AstNode formatter;

	public StringInterpolation(String template, List<Pair<Integer, AstNode>> interpolations, @Nullable AstNode formatter) {
