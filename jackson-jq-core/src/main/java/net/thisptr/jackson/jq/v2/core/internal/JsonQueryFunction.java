...
public class JsonQueryFunction<JsonNode> implements LegacyFunction {
	private Expression body;
	private List<String> params;
	private String name;
	private Scope<JsonNode> closure;

	public JsonQueryFunction(String name, List<String> params, Expression body, Scope<JsonNode> closure) {
		this.name = name;
		this.params = params;
		this.body = body;
	...
	private void pathRecursive(PathOutput<JsonNode> output, Scope<JsonNode> fnScope, Scope<JsonNode> scope, List<Expression> args, JsonNode in, @Nullable Path<JsonNode> path, int i) throws JsonQueryException {
		if (i == params.size()) {
