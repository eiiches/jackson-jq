 ...
 */
public final class FoldedErrorExpression<JsonNode> implements Expression<StackFrame, JsonNode>, FreeVariables {
	...
	public FoldedErrorExpression(Expression<StackFrame, JsonNode> delegate, List<JsonNode> values, JsonQueryException error) {
