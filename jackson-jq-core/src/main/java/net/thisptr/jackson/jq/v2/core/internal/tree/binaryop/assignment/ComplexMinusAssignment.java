...
public class ComplexMinusAssignment<JsonNode> extends ComplexAssignment<JsonNode> {
	public ComplexMinusAssignment(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, boolean inputFixed) {
		super(jsonProvider, lhs, rhs, new MinusOperator<>(), inputFixed);
	}
}
