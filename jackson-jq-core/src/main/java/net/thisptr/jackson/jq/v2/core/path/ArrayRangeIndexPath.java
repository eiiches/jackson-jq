...
public class ArrayRangeIndexPath<JsonNode> implements Path<JsonNode> {
	...
	private static <JsonNode> JsonNode mutate(JsonProvider<JsonNode> jsonProvider, @Var @Nullable JsonNode in, JsonNode start, JsonNode end, Mutation<JsonNode> mutation) throws JsonQueryException {
