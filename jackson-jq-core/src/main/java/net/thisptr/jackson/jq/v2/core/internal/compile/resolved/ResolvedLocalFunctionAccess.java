...
public class ResolvedLocalFunctionAccess<JsonNode> implements RewritableExpression<JsonNode>, FreeVariables {
	...
	public ResolvedLocalFunctionAccess(BindContext<JsonNode> bindContext, String name, int slot, List<AnalyzedExpression<JsonNode>> args, @Nullable FunctionDependsOnInfo info) {
