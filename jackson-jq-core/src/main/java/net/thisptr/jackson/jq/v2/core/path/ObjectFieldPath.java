...
public class ObjectFieldPath<JsonNode> implements Path<JsonNode> {
	...
	public static <JsonNode> void resolve(JsonProvider<JsonNode> jsonProvider, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, String key, boolean permissive, @Nullable Version version) throws JsonQueryException {
