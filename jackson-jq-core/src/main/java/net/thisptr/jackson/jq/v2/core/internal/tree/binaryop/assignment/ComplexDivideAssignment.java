...
public class ComplexDivideAssignment<JsonNode> extends AbstractComplexAssignment<JsonNode> {
	public ComplexDivideAssignment(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, Version version, boolean inputFixed, int lhsOutputIndex, int rhsOutputIndex) {
