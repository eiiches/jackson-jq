...
public class ComplexDivideAssignment<JsonNode> extends ComplexAssignment<JsonNode> {
	public ComplexDivideAssignment(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, boolean inputFixed) {
		super(jsonProvider, lhs, rhs, new DivideOperator<>(), inputFixed);
	}
}
