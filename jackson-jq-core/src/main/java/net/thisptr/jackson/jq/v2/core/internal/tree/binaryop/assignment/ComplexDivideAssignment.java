...
public class ComplexDivideAssignment<JsonNode> extends AbstractComplexAssignment<JsonNode> {
	public ComplexDivideAssignment(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
