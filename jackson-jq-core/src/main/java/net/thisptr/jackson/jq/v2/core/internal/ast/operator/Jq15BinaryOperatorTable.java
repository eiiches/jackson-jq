...
public final class Jq15BinaryOperatorTable implements BinaryOperatorTable {
	public static final Jq15BinaryOperatorTable INSTANCE = new Jq15BinaryOperatorTable();

	private final EnumMap<BinaryOperator, BinaryOperatorInfo> operatorInfo = new EnumMap<>(BinaryOperator.class);

	private Jq15BinaryOperatorTable() {
		put(BinaryOperator.PIPE, 8, BinaryOperatorInfo.Associativity.RIGHT);
		put(BinaryOperator.BINDING_PIPE, 0, BinaryOperatorInfo.Associativity.RIGHT);
