...
public class ModuloExpression<JsonNode> extends AbstractSimpleBinaryOperatorExpression<JsonNode> {
	...
	public ModuloExpression(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
