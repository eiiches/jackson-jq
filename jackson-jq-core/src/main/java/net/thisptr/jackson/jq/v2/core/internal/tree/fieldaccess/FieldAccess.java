...
public abstract class FieldAccess<JsonNode> implements Expression<JsonNode> {
	...
	protected static <JsonNode> void emitAllPath(JsonProvider<JsonNode> jsonProvider, boolean permissive, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, boolean tracking, @Nullable Version version) throws JsonQueryException {
	...
	protected static <JsonNode> void emitObjectFieldPath(JsonProvider<JsonNode> jsonProvider, boolean permissive, String key, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, boolean tracking, @Nullable Version version) throws JsonQueryException {
		if (tracking && UnrepresentablePath.isLost(ppath))
	...
	protected static <JsonNode> void emitArrayIndexPath(JsonProvider<JsonNode> jsonProvider, boolean permissive, JsonNode index, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, boolean tracking, @Nullable Version version) throws JsonQueryException {
	...
	protected static <JsonNode> void emitArrayIndexOfPath(JsonProvider<JsonNode> jsonProvider, boolean permissive, JsonNode subseqToLookFor, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, boolean tracking, @Nullable Version version) throws JsonQueryException {
	...
	protected static <JsonNode> void emitArrayRangeIndexPath(JsonProvider<JsonNode> jsonProvider, boolean permissive, JsonNode start, JsonNode end, JsonNode pobj, @Nullable Path<JsonNode> ppath, PathOutput<JsonNode> output, boolean tracking, @Nullable Version version) throws JsonQueryException {
