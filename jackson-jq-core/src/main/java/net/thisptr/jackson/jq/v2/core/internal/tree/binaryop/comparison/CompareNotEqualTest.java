...
public class CompareNotEqualTest<JsonNode> extends AbstractComparisonExpression<JsonNode> {
	public CompareNotEqualTest(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, int lhsOutputIndex, int rhsOutputIndex) {
