...
public class DivideExpression<JsonNode> extends AbstractSimpleBinaryOperatorExpression<JsonNode> {
	...
	public DivideExpression(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
