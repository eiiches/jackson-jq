...
public class BooleanAndExpression<JsonNode> extends AbstractBinaryOperatorExpression<JsonNode> {
	...
	public BooleanAndExpression(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, int lhsOutputIndex, int rhsOutputIndex) {
