 ...
 */
public interface RewritableExpression<JsonNode> extends Expression<StackFrame, JsonNode> {
	/**
	 ...
	 */
	Expression<StackFrame, JsonNode> rewriteChildren(ExpressionRewriter<JsonNode> rewriter);
}
