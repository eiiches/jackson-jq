...
public class MinusExpression<JsonNode> extends AbstractSimpleBinaryOperatorExpression<JsonNode> {
	...
	public MinusExpression(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
