...
public abstract class AbstractComplexAssignment<JsonNode> extends AbstractBinaryOperatorExpression<JsonNode> {
	...
	public AbstractComplexAssignment(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
