...
public class ComplexMultiplyAssignment<JsonNode> extends ComplexAssignment<JsonNode> {
	public ComplexMultiplyAssignment(JsonProvider<JsonNode> jsonProvider, Expression<StackFrame, JsonNode> lhs, Expression<StackFrame, JsonNode> rhs, boolean inputFixed) {
		super(jsonProvider, lhs, rhs, new MultiplyOperator<>(), inputFixed);
	}
}
