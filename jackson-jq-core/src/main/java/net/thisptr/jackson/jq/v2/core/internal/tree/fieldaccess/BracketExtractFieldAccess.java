...
public class BracketExtractFieldAccess<JsonNode> extends AbstractFieldAccess<JsonNode> {
	...
	public BracketExtractFieldAccess(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> src, boolean permissive, Version version, int targetOutputIndex) {
