...
public class UpdateAssignment<JsonNode> extends AbstractBinaryOperatorExpression<JsonNode> {
	...
	public UpdateAssignment(JsonProvider<JsonNode> jsonProvider, AnalyzedExpression<JsonNode> lhs, AnalyzedExpression<JsonNode> rhs, Version version, int lhsOutputIndex, int rhsOutputIndex) {
