 ...
 * {@code VersionRange} via {@link VersionRange#valueOf(VersionRangeSpec)}. Intended only as a
 ...
 * value) is a malformed spec and causes {@link VersionRange#valueOf(VersionRangeSpec)} to throw
