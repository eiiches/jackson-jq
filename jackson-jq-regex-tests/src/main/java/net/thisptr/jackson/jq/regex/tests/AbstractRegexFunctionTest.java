...
public abstract class AbstractRegexFunctionTest {
	...
	private static List<TestCase> loadTestCases(final String resourcePath) throws IOException {
		try (InputStream in = AbstractRegexFunctionTest.class.getClassLoader().getResourceAsStream(resourcePath)) {
			if (in == null)
	...
	public static Stream<String> testCases() throws IOException {
