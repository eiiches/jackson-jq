package net.thisptr.jackson.jq.v2.smoketests.java17;
...
public final class Java17SmokeTest {
	private Java17SmokeTest() {
	}
	...
	public static void main(String[] args) throws Exception {
		...
		testWithJsonProvider(JakartaJsonProvider.getInstance());
		System.out.println("Java 17 compatibility test passed for Jackson 2, Jackson 3, Gson, Jakarta, and all extension modules");
	}
	...
	private static <JsonNode> void testWithJsonProvider(JsonProvider<JsonNode> jsonProvider) throws Exception {
		...
		Environment<JsonNode> env = EnvironmentBuilder.withDefaultLoaders(jsonProvider, version, Java17SmokeTest.class.getClassLoader())
				.build();
