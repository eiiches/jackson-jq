...
public class ModuleDiscoveryTest {
	...
	public void functionContract() {
		...
		Expression<RuntimeContext, JsonNode> uuid3Expr = uuid3.bindArguments(Jackson2JsonProvider.getInstance(), Collections.singletonList(pureExpression()), Versions.JQ_1_6);
		...
		Expression<RuntimeContext, JsonNode> uuid5Expr = uuid5.bindArguments(Jackson2JsonProvider.getInstance(), Collections.singletonList(pureExpression()), Versions.JQ_1_6);
		...
		Expression<RuntimeContext, JsonNode> uuid4Expr = uuid4.bindArguments(Jackson2JsonProvider.getInstance(), Collections.emptyList(), Versions.JQ_1_6);
